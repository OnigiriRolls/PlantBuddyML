...
model.save('/gcs/plant-buddy-bucket/model_oxford/model_trained_valid9')
pd.DataFrame.from_dict(history.history).to_csv('/gcs/plant-buddy-bucket/model_oxford/history9.csv',index=False)
