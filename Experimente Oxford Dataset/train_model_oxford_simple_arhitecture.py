...
model.save('/gcs/plant-buddy-bucket/model_oxford/model_trained_valid12_4')
pd.DataFrame.from_dict(history.history).to_csv('/gcs/plant-buddy-bucket/model_oxford/history12_4.csv',index=False)
