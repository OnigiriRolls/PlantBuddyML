...
model.save('/gcs/plant-buddy-bucket/model_oxford/model_trained_valid13')
pd.DataFrame.from_dict(history.history).to_csv('/gcs/plant-buddy-bucket/model_oxford/history13.csv',index=False)
